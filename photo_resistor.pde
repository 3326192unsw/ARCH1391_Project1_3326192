...
//PhotoResistor Pin
int lightPin1 = 0; //the number of the photoresistor analog pin
int lightPin2 = 1; //the number of the photoresistor analog pin
int lightPin3 = 2; //the number of the photoresistor analog pin
int lightPin4 = 3; //the number of the photoresistor analog pin
int lightPin5 = 4; //the number of the photoresistor analog pin
int lightPin6 = 5; //the number of the photoresistor analog pin
...
void loop()
{
 ...
 if(analogRead(lightPin1, lightPin2, lightPin3, lightPin4,lightPin5,lightPin6) > threshold){
